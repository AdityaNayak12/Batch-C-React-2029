...
# 22. Best examples to teach in class, in order

If you want to teach this from beginner to advanced, this is the best sequence:

## Level 1: `setInterval`

Why? Very visual. Easy to see duplicate timers.

## Level 2: window resize listener

Why? Easy to explain attach/remove.

## Level 3: chat room subscription

Why? Teaches dependency-change cleanup.

## Level 4: fetch with `AbortController`

Why? Introduces stale request problem and race conditions.

## Level 5: search debounce + abort

Why? Real product-level frontend problem.

## Level 6: WebSocket / live collaboration

Why? Shows real industry significance.

## Level 7: media streams / geolocation / animation

Why? Shows cleanup beyond “just remove listener”.
